...
export const menuItems: MenuItem[] = [
    ...
    {
        title: 'Exams',
        icon: <div className="w-5 h-5 flex items-center justify-center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg></div>,
        featureKey: 'Exams',
        children: [
            // Paths fixed 12 Aug 2026: these previously lived under the
            // deleted "Academics (AI)" heading and pointed at nonexistent
            // routes (/dashboard/academics/cbt, /dashboard/settings/cbt-policies)
            // — CBT is actually gated by its own "Exams" feature flag and
            // its real routes live at /dashboard/cbt[/policies].
            { title: 'CBT Assessments', path: '/teacher/cbt' },
            { title: 'CBT Dashboard', path: '/dashboard/cbt' },
            { title: 'CBT Policies', path: '/dashboard/cbt/policies' }
        ]
    },
