    ...
    return (
        <div className="min-h-screen bg-[#FBF9F5] px-4 pb-20 pt-8 sm:px-6 lg:px-8">
            <div className="relative z-10 mx-auto max-w-6xl space-y-6">
                ...
                {/* Header Banner */}
                <div className={cn('overflow-hidden rounded-2xl border border-emerald-200/80 bg-white/90 shadow-xl shadow-emerald-900/5 transition-all duration-500', pageVisible ? 'opacity-100' : 'translate-y-3 opacity-0')}>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-0.5">
                                            <span className={cn(
                                                ...
                                                selectedRecord.source === 'AUTO' ? 'bg-emerald-100 text-emerald-800' : 'bg-[#1E4DA6]/10 text-[#122F69]'
                                            )}>
