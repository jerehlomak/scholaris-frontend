            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="md:col-span-1 rounded-2xl border border-slate-200 bg-white shadow-sm p-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label className="font-mono text-[10px] font-bold uppercase tracking-widest text-slate-400">Search Student <span className="text-[#1E4DA6]">*</span></label>
                            <Input className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 h-12 text-sm font-semibold text-slate-800 outline-none focus:border-[#1E4DA6]/60 focus:ring-2 focus:ring-[#1E4DA6]/10" placeholder="Search Student" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <button className="w-full text-center text-sm font-bold text-[#1E4DA6] hover:text-[#173F8C] transition-colors mt-2">or, Reload All</button>
                    </div>
                </div>
                ...
                <div className="md:col-span-3 rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                    <div className="px-5 py-4 border-b border-slate-100 bg-slate-50/60 flex items-center gap-2">
                        <Lock className="h-4 w-4 text-[#1E4DA6]" />
                                ...
                                {MOCK_DATA.map(student => (
                                    <tr key={student.id} className="hover:bg-slate-50/60 transition-colors">
                                        ...
                                        <td className="px-5 py-4">
                                            <Input defaultValue={student.username} className="h-9 w-32 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-800 focus:border-[#1E4DA6]/60" />
                                        </td>
                                        <td className="px-5 py-4">
                                            <div className="relative flex items-center w-40">
                                                <Input type={showPassword[student.id] ? 'text' : 'password'} defaultValue={student.password}
                                                    className="h-9 w-full rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-800 focus:border-[#1E4DA6]/60 pr-8 font-mono" />
                                        ...
                                        <td className="px-5 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button className="p-1.5 text-slate-400 hover:text-[#1E4DA6] hover:bg-[#1E4DA6]/5 rounded-lg transition-colors" title="Save"><Save className="h-4 w-4" /></button>
                                                <button className="p-1.5 text-slate-400 hover:text-[#1E4DA6] hover:bg-[#1E4DA6]/5 rounded-lg transition-colors" title="Send Email"><Mail className="h-4 w-4" /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
